...
namespace WebSite.BLL
{
	...
	/// Bll_SupportOrder
	/// </summary>
	public partial class Bll_SupportOrder
	{
		private readonly WebSite.DAL.Dal_SupportOrder dal=new WebSite.DAL.Dal_SupportOrder();
		public Bll_SupportOrder()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public WebSite.Model.Mod_SupportOrder GetModelByCache(int ID)
		{
			
			string CacheKey = "Mod_SupportOrderModel-" + ID;
			...
			return (WebSite.Model.Mod_SupportOrder)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<WebSite.Model.Mod_SupportOrder> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<WebSite.Model.Mod_SupportOrder> DataTableToList(DataTable dt)
		{
			List<WebSite.Model.Mod_SupportOrder> modelList = new List<WebSite.Model.Mod_SupportOrder>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				WebSite.Model.Mod_SupportOrder model;
        ...
        {
            return dal.GetListNiceName(strWhere, type);
        }
        /// <summary>
        /// 取寺院的产品
        /// </summary>
        ...
        {
            return dal.GetListProduct(strWhere, type);
        }
        /// <summary>
        /// 根据订单号得到一个对象实体
        /// </summary>
