...
namespace WebSite.BLL
{
	...
	/// Bll_MarketIntegral
	/// </summary>
	public partial class Bll_MarketIntegral
	{
		private readonly WebSite.DAL.Dal_MarketIntegral dal=new WebSite.DAL.Dal_MarketIntegral();
		public Bll_MarketIntegral()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public WebSite.Model.Mod_MarketIntegral GetModelByCache(int ID)
		{
			
			string CacheKey = "Mod_MarketIntegralModel-" + ID;
			...
			return (WebSite.Model.Mod_MarketIntegral)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<WebSite.Model.Mod_MarketIntegral> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<WebSite.Model.Mod_MarketIntegral> DataTableToList(DataTable dt)
		{
			List<WebSite.Model.Mod_MarketIntegral> modelList = new List<WebSite.Model.Mod_MarketIntegral>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				WebSite.Model.Mod_MarketIntegral model;
