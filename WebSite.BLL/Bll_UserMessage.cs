...
namespace WebSite.BLL
{
	...
	/// Bll_UserMessage
	/// </summary>
	public partial class Bll_UserMessage
	{
		private readonly WebSite.DAL.Dal_UserMessage dal=new WebSite.DAL.Dal_UserMessage();
		public Bll_UserMessage()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public WebSite.Model.Mod_UserMessage GetModelByCache(int ID)
		{
			
			string CacheKey = "Mod_UserMessageModel-" + ID;
			...
			return (WebSite.Model.Mod_UserMessage)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<WebSite.Model.Mod_UserMessage> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<WebSite.Model.Mod_UserMessage> DataTableToList(DataTable dt)
		{
			List<WebSite.Model.Mod_UserMessage> modelList = new List<WebSite.Model.Mod_UserMessage>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				WebSite.Model.Mod_UserMessage model;
        ...
        {
            return dal.UpdateStatus(Status, SUserID, TypeMode);
        }
