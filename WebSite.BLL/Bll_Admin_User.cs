...
namespace WebSite.BLL
{
	...
	/// Bll_Admin_User
	/// </summary>
	public partial class Bll_Admin_User
	{
		private readonly WebSite.DAL.Dal_Admin_User dal=new WebSite.DAL.Dal_Admin_User();
		public Bll_Admin_User()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public WebSite.Model.Mod_Admin_User GetModelByCache(int ID)
		{
			
			string CacheKey = "Mod_Admin_UserModel-" + ID;
			...
			return (WebSite.Model.Mod_Admin_User)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<WebSite.Model.Mod_Admin_User> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<WebSite.Model.Mod_Admin_User> DataTableToList(DataTable dt)
		{
			List<WebSite.Model.Mod_Admin_User> modelList = new List<WebSite.Model.Mod_Admin_User>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				WebSite.Model.Mod_Admin_User model;
