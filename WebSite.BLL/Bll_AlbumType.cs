...
namespace WebSite.BLL
{
	...
	/// Bll_AlbumType
	/// </summary>
	public partial class Bll_AlbumType
	{
		private readonly WebSite.DAL.Dal_AlbumType dal=new WebSite.DAL.Dal_AlbumType();
		public Bll_AlbumType()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public WebSite.Model.Mod_AlbumType GetModelByCache(int ID)
		{
			
			string CacheKey = "Mod_AlbumTypeModel-" + ID;
			...
			return (WebSite.Model.Mod_AlbumType)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<WebSite.Model.Mod_AlbumType> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<WebSite.Model.Mod_AlbumType> DataTableToList(DataTable dt)
		{
			List<WebSite.Model.Mod_AlbumType> modelList = new List<WebSite.Model.Mod_AlbumType>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				WebSite.Model.Mod_AlbumType model;
