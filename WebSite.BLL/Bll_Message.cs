...
namespace WebSite.BLL
{
	...
	/// Bll_Message
	/// </summary>
	public partial class Bll_Message
	{
		private readonly WebSite.DAL.Dal_Message dal=new WebSite.DAL.Dal_Message();
		public Bll_Message()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public WebSite.Model.Mod_Message GetModelByCache(int ID)
		{
			
			string CacheKey = "Mod_MessageModel-" + ID;
			...
			return (WebSite.Model.Mod_Message)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<WebSite.Model.Mod_Message> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<WebSite.Model.Mod_Message> DataTableToList(DataTable dt)
		{
			List<WebSite.Model.Mod_Message> modelList = new List<WebSite.Model.Mod_Message>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				WebSite.Model.Mod_Message model;
