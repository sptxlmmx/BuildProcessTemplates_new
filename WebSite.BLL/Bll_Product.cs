...
namespace WebSite.BLL
{
	...
	{
		private readonly WebSite.DAL.Dal_Product dal=new WebSite.DAL.Dal_Product();
		public Bll_Product()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public WebSite.Model.Mod_Product GetModelByCache(int ID)
		{
			
			string CacheKey = "Mod_ProductModel-" + ID;
			...
			return (WebSite.Model.Mod_Product)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<WebSite.Model.Mod_Product> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<WebSite.Model.Mod_Product> DataTableToList(DataTable dt)
		{
			List<WebSite.Model.Mod_Product> modelList = new List<WebSite.Model.Mod_Product>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				WebSite.Model.Mod_Product model;
        ...
        {
            return dal.UpShopState(IDlist, ShopState);
        }
        /// <summary>
        /// 批量修改
        /// </summary>
        ...
        {
            return dal.UpTypeIDPath(TypeIDPath, TypeID);
        }
