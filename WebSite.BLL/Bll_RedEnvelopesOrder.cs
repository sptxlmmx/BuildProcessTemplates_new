...
{
	/// <summary>
	/// Bll_RedEnvelopesOrder
	/// </summary>
	public partial class Bll_RedEnvelopesOrder
	{
		private readonly WebSite.DAL.Dal_RedEnvelopesOrder dal=new WebSite.DAL.Dal_RedEnvelopesOrder();
		public Bll_RedEnvelopesOrder()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public WebSite.Model.Mod_RedEnvelopesOrder GetModelByCache(int ID)
		{
			
			string CacheKey = "Mod_RedEnvelopesOrderModel-" + ID;
			...
			return (WebSite.Model.Mod_RedEnvelopesOrder)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<WebSite.Model.Mod_RedEnvelopesOrder> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<WebSite.Model.Mod_RedEnvelopesOrder> DataTableToList(DataTable dt)
		{
			List<WebSite.Model.Mod_RedEnvelopesOrder> modelList = new List<WebSite.Model.Mod_RedEnvelopesOrder>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				WebSite.Model.Mod_RedEnvelopesOrder model;
