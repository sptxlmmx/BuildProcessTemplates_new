...
{
	/// <summary>
	/// Bll_MarketIntegralOrder
	/// </summary>
	public partial class Bll_MarketIntegralOrder
	{
		private readonly WebSite.DAL.Dal_MarketIntegralOrder dal=new WebSite.DAL.Dal_MarketIntegralOrder();
		public Bll_MarketIntegralOrder()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public WebSite.Model.Mod_MarketIntegralOrder GetModelByCache(int ID)
		{
			
			string CacheKey = "Mod_MarketIntegralOrderModel-" + ID;
			...
			return (WebSite.Model.Mod_MarketIntegralOrder)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<WebSite.Model.Mod_MarketIntegralOrder> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<WebSite.Model.Mod_MarketIntegralOrder> DataTableToList(DataTable dt)
		{
			List<WebSite.Model.Mod_MarketIntegralOrder> modelList = new List<WebSite.Model.Mod_MarketIntegralOrder>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				WebSite.Model.Mod_MarketIntegralOrder model;
        ...
        {
            return dal.GetListByPageAllIntegral(strWhere);
        }
        /// <summary>
        /// 卖家的订单条数
        /// </summary>
        ...
        {
            return dal.GetListByPageAllIntegralCount(strWhere);
        }
        /// <summary>
        /// 根据订单号得到一个对象实体
        /// </summary>
