...
namespace WebSite.BLL
{
	...
	/// Bll_MallShop
	/// </summary>
	public partial class Bll_MallShop
	{
		private readonly WebSite.DAL.Dal_MallShop dal=new WebSite.DAL.Dal_MallShop();
		public Bll_MallShop()
		{}
		#region  BasicMethod
		...
		/// 获得数据列表
		/// </summary>
		public List<WebSite.Model.Mod_MallShop> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<WebSite.Model.Mod_MallShop> DataTableToList(DataTable dt)
		{
			List<WebSite.Model.Mod_MallShop> modelList = new List<WebSite.Model.Mod_MallShop>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				WebSite.Model.Mod_MallShop model;
