...
namespace WebSite.BLL
{
	...
	/// Bll_SupportTemple
	/// </summary>
	public partial class Bll_SupportTemple
	{
		private readonly WebSite.DAL.Dal_SupportTemple dal=new WebSite.DAL.Dal_SupportTemple();
		public Bll_SupportTemple()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public WebSite.Model.Mod_SupportTemple GetModelByCache(int ID)
		{
			
			string CacheKey = "Mod_SupportTempleModel-" + ID;
			...
			return (WebSite.Model.Mod_SupportTemple)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<WebSite.Model.Mod_SupportTemple> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<WebSite.Model.Mod_SupportTemple> DataTableToList(DataTable dt)
		{
			List<WebSite.Model.Mod_SupportTemple> modelList = new List<WebSite.Model.Mod_SupportTemple>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				WebSite.Model.Mod_SupportTemple model;
        ...
        {
            return dal.GetModel(UserID, TUserID);
        }
        /// <summary>
        /// 删除一条数据
        /// </summary>
        ...
        {
            return dal.GetListByPageEnterprise(strWhere, orderby, startIndex, endIndex);
        }
