...
namespace WebSite.BLL
{
	...
	/// Bll_Fabulous
	/// </summary>
	public partial class Bll_Fabulous
	{
		private readonly WebSite.DAL.Dal_Fabulous dal=new WebSite.DAL.Dal_Fabulous();
		public Bll_Fabulous()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public WebSite.Model.Mod_Fabulous GetModelByCache(int ID)
		{
			
			string CacheKey = "Mod_FabulousModel-" + ID;
			...
			return (WebSite.Model.Mod_Fabulous)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<WebSite.Model.Mod_Fabulous> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<WebSite.Model.Mod_Fabulous> DataTableToList(DataTable dt)
		{
			List<WebSite.Model.Mod_Fabulous> modelList = new List<WebSite.Model.Mod_Fabulous>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				WebSite.Model.Mod_Fabulous model;
