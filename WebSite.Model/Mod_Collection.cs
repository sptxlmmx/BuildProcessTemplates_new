...
{
	/// <summary>
	/// Mod_Collection:实体类(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public partial class Mod_Collection
	{
		public Mod_Collection()
		{
		...
		private string _newsintroduction;
		private int _newsbrowsecount;
		...
		{
			set{ _newsintroduction=value;}
			get{return _newsintroduction;}
		}
		/// <summary>
		/// 
		/// </summary>
		...
		{
			set{ _newsbrowsecount=value;}
			get{return _newsbrowsecount;}
		}
		/// <summary>
		/// 
		/// </summary>
