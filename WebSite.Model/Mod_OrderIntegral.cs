...
{
	/// <summary>
	/// Mod_OrderIntegral:实体类(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public partial class Mod_OrderIntegral
	{
		public Mod_OrderIntegral()
		{
		...
		private DateTime _refunddate= Convert.ToDateTime("1900-01-01 00:00:00.000");
		...
		/// <summary>
		/// （0待确认，10待付款，20待发货，30收货确认中，40取消,50:无效,60:退货,100:完成）
		/// </summary>
		public int State
		{
			set{ _state=value;}
