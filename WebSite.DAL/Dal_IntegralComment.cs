...
{
	/// <summary>
	/// 数据访问类:Dal_IntegralComment
	/// </summary>
	public partial class Dal_IntegralComment
	{
		public Dal_IntegralComment()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "SW_IntegralComment"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from SW_IntegralComment");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(WebSite.Model.Mod_IntegralComment model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into SW_IntegralComment(");
			strSql.Append("Model,ProcutID,ProcutTitle,ProcutImage,OrderID,OrderNo,SkuID,SkuSpec,Integral,ReuserID,ReuserName,ReuserNickName,ReuserLevelID,ReuserImage,ReuserClass,UserParentsID,ReplyUserID,ReplyUserName,ReplyNickName,ReplyID,Content1,Explanation,IsReport,ColumnID,ReColumnID,FabulousCount,ReplyCount,Score,State,IsReview,IsBest,IsLook,OrderBy,AddDate,WebSiteID)");
			strSql.Append(" values (");
			strSql.Append("@Model,@ProcutID,@ProcutTitle,@ProcutImage,@OrderID,@OrderNo,@SkuID,@SkuSpec,@Integral,@ReuserID,@ReuserName,@ReuserNickName,@ReuserLevelID,@ReuserImage,@ReuserClass,@UserParentsID,@ReplyUserID,@ReplyUserName,@ReplyNickName,@ReplyID,@Content1,@Explanation,@IsReport,@ColumnID,@ReColumnID,@FabulousCount,@ReplyCount,@Score,@State,@IsReview,@IsBest,@IsLook,@OrderBy,@AddDate,@WebSiteID)");
			strSql.Append(";select @@IDENTITY");
			SqlParameter[] parameters = {
					new SqlParameter("@Model", SqlDbType.VarChar,50),
					new SqlParameter("@ProcutID", SqlDbType.Int,4),
					new SqlParameter("@ProcutTitle", SqlDbType.VarChar,200),
					new SqlParameter("@ProcutImage", SqlDbType.VarChar,200),
					new SqlParameter("@OrderID", SqlDbType.Int,4),
					new SqlParameter("@OrderNo", SqlDbType.VarChar,200),
					new SqlParameter("@SkuID", SqlDbType.Int,4),
					new SqlParameter("@SkuSpec", SqlDbType.VarChar,200),
			...
			parameters[1].Value = model.ProcutID;
			parameters[2].Value = model.ProcutTitle;
			parameters[3].Value = model.ProcutImage;
			...
			parameters[10].Value = model.ReuserName;
			parameters[11].Value = model.ReuserNickName;
			parameters[12].Value = model.ReuserLevelID;
			parameters[13].Value = model.ReuserImage;
			parameters[14].Value = model.ReuserClass;
			parameters[15].Value = model.UserParentsID;
			parameters[16].Value = model.ReplyUserID;
			parameters[17].Value = model.ReplyUserName;
			parameters[18].Value = model.ReplyNickName;
			parameters[19].Value = model.ReplyID;
			parameters[20].Value = model.Content1;
			parameters[21].Value = model.Explanation;
			parameters[22].Value = model.IsReport;
			parameters[23].Value = model.ColumnID;
			parameters[24].Value = model.ReColumnID;
			parameters[25].Value = model.FabulousCount;
			parameters[26].Value = model.ReplyCount;
			parameters[27].Value = model.Score;
			parameters[28].Value = model.State;
			parameters[29].Value = model.IsReview;
			parameters[30].Value = model.IsBest;
			parameters[31].Value = model.IsLook;
			parameters[32].Value = model.OrderBy;
			parameters[33].Value = model.AddDate;
			parameters[34].Value = model.WebSiteID;
			...
			else
			{
                ...
                //操作图片集
                Dal_IntegralCommentImage DIntegralCommentImage = new Dal_IntegralCommentImage();
                DIntegralCommentImage.OperateList(model.IntegralCommentImage, model.ID, true);
                return model.ID;
			}
		}
		/// <summary>
		/// 更新一条数据
		/// </summary>
		public bool Update(WebSite.Model.Mod_IntegralComment model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update SW_IntegralComment set ");
			strSql.Append("Model=@Model,");
			strSql.Append("ProcutID=@ProcutID,");
			strSql.Append("ProcutTitle=@ProcutTitle,");
			strSql.Append("ProcutImage=@ProcutImage,");
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(WebSite.Model.Mod_IntegralComment model, bool IsSub)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update SW_IntegralComment set ");
            strSql.Append("Model=@Model,");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from SW_IntegralComment ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
			...
			if (rows > 0)
			{
                //操作图片集
                Dal_IntegralCommentImage DIntegralCommentImage = new Dal_IntegralCommentImage();
                DIntegralCommentImage.DeleteFile(ID.ToString(), true);
				return true;
			}
			else
			{
		...
		public bool DeleteList(string IDlist )
		{
			...
			if (rows > 0)
			{
                //操作图片集
                Dal_IntegralCommentImage DIntegralCommentImage = new Dal_IntegralCommentImage();
                DIntegralCommentImage.DeleteFile(IDlist, true);
				return true;
			}
			else
			{
		...
		/// 得到一个对象实体
		/// </summary>
		public WebSite.Model.Mod_IntegralComment GetModel(int ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,Model,ProcutID,ProcutTitle,ProcutImage,OrderID,OrderNo,SkuID,SkuSpec,Integral,ReuserID,ReuserName,ReuserNickName,ReuserLevelID,ReuserImage,ReuserClass,UserParentsID,ReplyUserID,ReplyUserName,ReplyNickName,ReplyID,Content1,Explanation,IsReport,ColumnID,ReColumnID,FabulousCount,ReplyCount,Score,State,IsReview,IsBest,IsLook,OrderBy,AddDate,WebSiteID from SW_IntegralComment ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
			...
			WebSite.Model.Mod_IntegralComment model=new WebSite.Model.Mod_IntegralComment();
		...
		/// 得到一个对象实体
		/// </summary>
		public WebSite.Model.Mod_IntegralComment DataRowToModel(DataRow row)
		{
			WebSite.Model.Mod_IntegralComment model=new WebSite.Model.Mod_IntegralComment();
			if (row != null)
			{
				...
				if(row["ProcutID"]!=null && row["ProcutID"].ToString()!="")
				{
					model.ProcutID=int.Parse(row["ProcutID"].ToString());
				}
				if(row["ProcutTitle"]!=null)
				{
					model.ProcutTitle=row["ProcutTitle"].ToString();
				}
				if(row["ProcutImage"]!=null)
				{
					model.ProcutImage=row["ProcutImage"].ToString();
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,Model,ProcutID,ProcutTitle,ProcutImage,OrderID,OrderNo,SkuID,SkuSpec,Integral,ReuserID,ReuserName,ReuserNickName,ReuserLevelID,ReuserImage,ReuserClass,UserParentsID,ReplyUserID,ReplyUserName,ReplyNickName,ReplyID,Content1,Explanation,IsReport,ColumnID,ReColumnID,FabulousCount,ReplyCount,Score,State,IsReview,IsBest,IsLook,OrderBy,AddDate,WebSiteID ");
			strSql.Append(" FROM SW_IntegralComment ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,Model,ProcutID,ProcutTitle,ProcutImage,OrderID,OrderNo,SkuID,SkuSpec,Integral,ReuserID,ReuserName,ReuserNickName,ReuserLevelID,ReuserImage,ReuserClass,UserParentsID,ReplyUserID,ReplyUserName,ReplyNickName,ReplyID,Content1,Explanation,IsReport,ColumnID,ReColumnID,FabulousCount,ReplyCount,Score,State,IsReview,IsBest,IsLook,OrderBy,AddDate,WebSiteID ");
			strSql.Append(" FROM SW_IntegralComment ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            if (startIndex <= 1)
            {
                strSql = "select top " + endIndex + " * from SW_IntegralComment where  " + strWhere + "  order by " + orderby + " ";
            }
            else
            {
                strSql = "select top " + endIndex + " * from SW_IntegralComment where  " + strWhere + " and  ID not in ( select top " + endIndex * (startIndex - 1) + " ID from SW_IntegralComment where  " + strWhere + "  order by " + orderby + " ) order by " + orderby + " ";
            }
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "SW_IntegralComment";
        ...
        {
            string strSql = "";
            strSql = "select COUNT(*) from SW_IntegralComment where  " + strWhere + "";
