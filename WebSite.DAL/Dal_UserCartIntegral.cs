...
{
	/// <summary>
	/// 数据访问类:Dal_UserCartIntegral
	/// </summary>
	public partial class Dal_UserCartIntegral
	{
		public Dal_UserCartIntegral()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "SW_UserCartIntegral"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from SW_UserCartIntegral");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(WebSite.Model.Mod_UserCartIntegral model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into SW_UserCartIntegral(");
			strSql.Append("Model,TypeID,CartID,ProductID,ProductNo,ProductName,ProductPic,StockCount,MinCount,SkuID,SkuNo,SkuSpec,Price1,Price2,Price3,Price4,Weight,Integral,Integral2,IsFreeFreight,BuyCount,UserID,State,AddDate,ProductUrl,WebSiteID)");
			...
			parameters[18].Value = model.Integral2;
			parameters[19].Value = model.IsFreeFreight;
			parameters[20].Value = model.BuyCount;
			parameters[21].Value = model.UserID;
			parameters[22].Value = model.State;
			parameters[23].Value = model.AddDate;
			parameters[24].Value = model.ProductUrl;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(WebSite.Model.Mod_UserCartIntegral model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update SW_UserCartIntegral set ");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from SW_UserCartIntegral ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public WebSite.Model.Mod_UserCartIntegral GetModel(int ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,Model,TypeID,CartID,ProductID,ProductNo,ProductName,ProductPic,StockCount,MinCount,SkuID,SkuNo,SkuSpec,Price1,Price2,Price3,Price4,Weight,Integral,Integral2,IsFreeFreight,BuyCount,UserID,State,AddDate,ProductUrl,WebSiteID from SW_UserCartIntegral ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
			...
			WebSite.Model.Mod_UserCartIntegral model=new WebSite.Model.Mod_UserCartIntegral();
		...
		/// 得到一个对象实体
		/// </summary>
		public WebSite.Model.Mod_UserCartIntegral DataRowToModel(DataRow row)
		{
			WebSite.Model.Mod_UserCartIntegral model=new WebSite.Model.Mod_UserCartIntegral();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,Model,TypeID,CartID,ProductID,ProductNo,ProductName,ProductPic,StockCount,MinCount,SkuID,SkuNo,SkuSpec,Price1,Price2,Price3,Price4,Weight,Integral,Integral2,IsFreeFreight,BuyCount,UserID,State,AddDate,ProductUrl,WebSiteID ");
			strSql.Append(" FROM SW_UserCartIntegral ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,Model,TypeID,CartID,ProductID,ProductNo,ProductName,ProductPic,StockCount,MinCount,SkuID,SkuNo,SkuSpec,Price1,Price2,Price3,Price4,Weight,Integral,Integral2,IsFreeFreight,BuyCount,UserID,State,AddDate,ProductUrl,WebSiteID ");
			strSql.Append(" FROM SW_UserCartIntegral ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            if (startIndex <= 1)
            {
                strSql = "select top " + endIndex + " * from SW_UserCartIntegral where  " + strWhere + "  order by " + orderby + " ";
            }
            else
            {
                strSql = "select top " + endIndex + " * from SW_UserCartIntegral where  " + strWhere + " and  ID not in ( select top " + endIndex * (startIndex - 1) + " ID from SW_UserCartIntegral where  " + strWhere + "  order by " + orderby + " ) order by " + orderby + " ";
            }
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "SW_UserCartIntegral";
        ...
        /// 得到一个对象实体
        /// </summary>
        public WebSite.Model.Mod_UserCartIntegral GetModel(int ProductID, int SkuID, int UserID, int WebSiteID)
        {
