...
namespace WebSite.DAL
{
    ...
    /// 数据访问类:Dal_HelpType
    /// </summary>
    public partial class Dal_HelpType
    {
        public Dal_HelpType()
        { }
        #region  BasicMethod
        ...
        public int GetMaxId()
        {
            return DbHelperSQL.GetMaxID("ID", "SW_HelpType");
        }
        ...
        public bool Exists(int ID)
        {
            ...
            strSql.Append("select count(1) from SW_HelpType");
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(WebSite.Model.Mod_HelpType model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into SW_HelpType(");
            ...
            else
            {
                ...
                {
                    WebSite.Model.Mod_HelpType MBaseType = GetModel(model.ParentID);
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(WebSite.Model.Mod_HelpType model)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update SW_HelpType set ");
        ...
        public bool Delete(int ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from SW_HelpType ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
        ...
        /// 得到一个对象实体
        /// </summary>
        public WebSite.Model.Mod_HelpType GetModel(int ID)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 ID,Model,Title,AddDate,OrderBy,ParentID,IDPath,WebSiteID,Link,Info,Content,State,Image,DisplayMode,IncludeType,ColumnID,Decimals,IsChocie,IsAttribute,IsTemplate,IsImageTemplate,Attr1,Attr2,Attr3,Attr4,Attr5,Attr6,Attr7,Attr8,Attr9 from SW_HelpType ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
            ...
            WebSite.Model.Mod_HelpType model = new WebSite.Model.Mod_HelpType();
        ...
        /// 得到一个对象实体
        /// </summary>
        public WebSite.Model.Mod_HelpType DataRowToModel(DataRow row)
        {
            WebSite.Model.Mod_HelpType model = new WebSite.Model.Mod_HelpType();
            if (row != null)
            {
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM SW_HelpType ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            if (startIndex <= 1)
            {
                strSql = "select top " + endIndex + " * from SW_HelpType where  " + strWhere + "  order by " + orderby + " ";
            }
            else
            {
                strSql = "select top " + endIndex + " * from SW_HelpType where  " + strWhere + " and  ID not in ( select top " + endIndex * (startIndex - 1) + " ID from SW_HelpType where  " + strWhere + "  order by " + orderby + " ) order by " + orderby + " ";
            }
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "SW_HelpType";
        ...
        /// 修改子类路径
        /// </summary>
        public bool ModifyIDPath(WebSite.Model.Mod_HelpType model, string OldIDPath)
        {
            using (SqlConnection conn = new SqlConnection(DbHelperSQL.connectionString))
            {
                ...
                using (SqlTransaction trans = conn.BeginTransaction())
                {
                    ...
                    {
                        StringBuilder strSql = new StringBuilder();
                        strSql.Append("select * from SW_HelpType where IDPath like '" + OldIDPath + "%'");
