...
namespace WebSite.DAL
{
    ...
    public partial class Dal_User
    {
        ...
        public int GetMaxId()
        {
            return DbHelperSQL.GetMaxID("ID", "SW_User");
        }
        ...
        public bool Exists(int ID)
        {
            ...
            strSql.Append("select count(1) from SW_User");
        ...
        public int Add(WebSite.Model.Mod_User model)
        {
            ...
            SqlParameter[] parameters = {
					...
					new SqlParameter("@IntegralQfPt", SqlDbType.Int,4),
					new SqlParameter("@IsIntegralPayFreeSecret", SqlDbType.Int,4)};
            ...
            parameters[6].Value = model.Problem;
            ...
            parameters[12].Value = model.PicSmall;
            parameters[13].Value = model.PicBig;
            parameters[14].Value = model.State;
            parameters[15].Value = model.IsFreeBroker;
            parameters[16].Value = model.IsShop;
            parameters[17].Value = model.Integral;
            parameters[18].Value = model.TotalIntegral;
            parameters[19].Value = model.FreezeIntegral;
            parameters[20].Value = model.IntegralSell;
            parameters[21].Value = model.IntegralSellFreeze;
            parameters[22].Value = model.Money;
            parameters[23].Value = model.ConsumptionMoney;
            parameters[24].Value = model.FreezeMoney;
            parameters[25].Value = model.TypeID;
            parameters[26].Value = model.LevelID;
            parameters[27].Value = model.LevelClass;
            parameters[28].Value = model.LevelName;
            parameters[29].Value = model.LevelIntegral;
            parameters[30].Value = model.LevelMoney;
            parameters[31].Value = model.ModifyDate;
            parameters[32].Value = model.OrderBy;
            parameters[33].Value = model.Email;
            parameters[34].Value = model.EmailCode;
            parameters[35].Value = model.EmailAudit;
            parameters[36].Value = model.EmailAuditDate;
            parameters[37].Value = model.Countries;
            parameters[38].Value = model.Province;
            parameters[39].Value = model.City;
            parameters[40].Value = model.Region;
            parameters[41].Value = model.Address;
            parameters[42].Value = model.Mobile;
            parameters[43].Value = model.Contact;
            parameters[44].Value = model.HomeUrl;
            parameters[45].Value = model.NewLoginIP;
            parameters[46].Value = model.NewLoginDate;
            parameters[47].Value = model.LoginIP;
            parameters[48].Value = model.LoginDate;
            parameters[49].Value = model.LoginCount;
            parameters[50].Value = model.RegisterIP;
            parameters[51].Value = model.RegisterDate;
            parameters[52].Value = model.UnionID;
            parameters[53].Value = model.SignCount;
            parameters[54].Value = model.SignDate;
            parameters[55].Value = model.BrowseCount;
            parameters[56].Value = model.CommentCount;
            parameters[57].Value = model.FabulousCount;
            parameters[58].Value = model.ReportCount;
            parameters[59].Value = model.FollowCount;
            parameters[60].Value = model.FansCount;
            parameters[61].Value = model.UserRemarks;
            parameters[62].Value = model.WebSiteID;
            parameters[63].Value = model.IsNeedAudit;
            parameters[64].Value = model.PointAllmoney;
            parameters[65].Value = model.PointAllIntegral;
            parameters[66].Value = model.MboxAllmoney;
            parameters[67].Value = model.MboxAllIntegral;
            parameters[68].Value = model.ActionCount;
            parameters[69].Value = model.MemberMessageids;
            parameters[70].Value = model.Icard;
            parameters[71].Value = model.IcardUrl;
            parameters[72].Value = model.IcardUrl2;
            parameters[73].Value = model.Qq;
            parameters[74].Value = model.WeiXin;
            parameters[75].Value = model.CurrentResidence;
            parameters[76].Value = model.IsPublic;
            parameters[77].Value = model.AuditState;
            parameters[78].Value = model.AuthenticationID;
            parameters[79].Value = model.AuthenticationName;
            parameters[80].Value = model.FaHao;
            parameters[81].Value = model.GYShiFu;
            parameters[82].Value = model.GYDaoChang;
            parameters[83].Value = model.GYYear;
            parameters[84].Value = model.Enterprise;
            parameters[85].Value = model.EnterpriseNum;
            parameters[86].Value = model.EnterpriseUrl;
            parameters[87].Value = model.Industry;
            parameters[88].Value = model.RegAddress;
            parameters[89].Value = model.RegUrl;
            parameters[90].Value = model.Header;
            parameters[91].Value = model.HeaderMobile;
            parameters[92].Value = model.CJDaoChang;
            parameters[93].Value = model.CJYear;
            parameters[94].Value = model.Masters;
            parameters[95].Value = model.CZDaoChang;
            parameters[96].Value = model.XZDaoChang;
            parameters[97].Value = model.IsOrdained;
            parameters[98].Value = model.OrdaineUrl1;
            parameters[99].Value = model.OrdaineUrl2;
            parameters[100].Value = model.PopularName;
            parameters[101].Value = model.DCAddress;
            parameters[102].Value = model.DCAttribute;
            parameters[103].Value = model.QualificationsUrl;
            parameters[104].Value = model.Remarks;
            parameters[105].Value = model.Abbot;
            parameters[106].Value = model.AbbotIcard;
            parameters[107].Value = model.AbbotUrl;
            parameters[108].Value = model.AbbotUrl2;
            parameters[109].Value = model.AbbotMobile;
            parameters[110].Value = model.DCUserName;
            parameters[111].Value = model.DCMobile;
            parameters[112].Value = model.BuddhistMonksM;
            parameters[113].Value = model.BuddhistMonksW;
            parameters[114].Value = model.BuddhistMonksCount;
            parameters[115].Value = model.BankName;
            parameters[116].Value = model.BankICard;
            parameters[117].Value = model.Bank;
            parameters[118].Value = model.CardNum;
            parameters[119].Value = model.OtherInt1;
            parameters[120].Value = model.OtherInt2;
            parameters[121].Value = model.OtherInt3;
            parameters[122].Value = model.OtherInt4;
            parameters[123].Value = model.OtherInt5;
            parameters[124].Value = model.OtherInt6;
            parameters[125].Value = model.OtherInt7;
            parameters[126].Value = model.OtherInt8;
            parameters[127].Value = model.OtherInt9;
            parameters[128].Value = model.OtherInt10;
            parameters[129].Value = model.OtherInt11;
            parameters[130].Value = model.OtherInt12;
            parameters[131].Value = model.OtherInt13;
            parameters[132].Value = model.OtherInt14;
            parameters[133].Value = model.OtherInt15;
            parameters[134].Value = model.OtherString1;
            parameters[135].Value = model.OtherString2;
            parameters[136].Value = model.OtherString3;
            parameters[137].Value = model.OtherString4;
            parameters[138].Value = model.OtherString5;
            parameters[139].Value = model.OtherString6;
            parameters[140].Value = model.OtherString7;
            parameters[141].Value = model.OtherString8;
            parameters[142].Value = model.OtherString9;
            parameters[143].Value = model.OtherString10;
            parameters[144].Value = model.OtherString11;
            parameters[145].Value = model.OtherString12;
            parameters[146].Value = model.OtherString13;
            parameters[147].Value = model.OtherString14;
            parameters[148].Value = model.OtherString15;
            parameters[149].Value = model.OtherText1;
            parameters[150].Value = model.OtherText2;
            parameters[151].Value = model.OtherText3;
            parameters[152].Value = model.OtherText4;
            parameters[153].Value = model.OtherText5;
            parameters[154].Value = model.MemTypeIDs1;
            parameters[155].Value = model.MemTypeIDs2;
            parameters[156].Value = model.MemTypeIDs3;
            parameters[157].Value = model.MemTypeIDs4;
            parameters[158].Value = model.MemTypeIDs5;
            parameters[159].Value = model.MemTypeIDs6;
            parameters[160].Value = model.MemTypeIDs7;
            parameters[161].Value = model.MemTypeIDs8;
            parameters[162].Value = model.MemTypeIDs9;
            parameters[163].Value = model.MemTypeIDs10;
            parameters[164].Value = model.MemTypeIDs11;
            parameters[165].Value = model.MemTypeIDs12;
            parameters[166].Value = model.MemTypeIDs13;
            parameters[167].Value = model.MemTypeIDs14;
            parameters[168].Value = model.MemTypeIDs15;
            parameters[169].Value = model.MemTypeIDs;
            parameters[170].Value = model.MemTypeIDCount;
            parameters[171].Value = model.MemTypeIDs7AttrIDS;
            parameters[172].Value = model.IntegralQfPt;
            parameters[173].Value = model.IsIntegralPayFreeSecret;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update SW_User set ");
            ...
            strSql.Append("IntegralQfPt=@IntegralQfPt,");
            strSql.Append("IsIntegralPayFreeSecret=@IsIntegralPayFreeSecret");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
					new SqlParameter("@Model", SqlDbType.VarChar,50),
					new SqlParameter("@UserName", SqlDbType.NVarChar,200),
        ...
        public bool Delete(int ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from SW_User ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
        ...
        public WebSite.Model.Mod_User GetModel(int ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 ID,Model,UserName,RealName,NiceName,Password,PayPassword,Problem,Answer,Sex,Company,BirthDate,Image,PicSmall,PicBig,State,IsFreeBroker,IsShop,Integral,TotalIntegral,FreezeIntegral,IntegralSell,IntegralSellFreeze,Money,ConsumptionMoney,FreezeMoney,TypeID,LevelID,LevelClass,LevelName,LevelIntegral,LevelMoney,ModifyDate,OrderBy,Email,EmailCode,EmailAudit,EmailAuditDate,Countries,Province,City,Region,Address,Mobile,Contact,HomeUrl,NewLoginIP,NewLoginDate,LoginIP,LoginDate,LoginCount,RegisterIP,RegisterDate,UnionID,SignCount,SignDate,BrowseCount,CommentCount,FabulousCount,ReportCount,FollowCount,FansCount,UserRemarks,WebSiteID,IsNeedAudit,PointAllmoney,PointAllIntegral,MboxAllmoney,MboxAllIntegral,ActionCount,MemberMessageids,Icard,IcardUrl,IcardUrl2,Qq,WeiXin,CurrentResidence,IsPublic,AuditState,AuthenticationID,AuthenticationName,FaHao,GYShiFu,GYDaoChang,GYYear,Enterprise,EnterpriseNum,EnterpriseUrl,Industry,RegAddress,RegUrl,Header,HeaderMobile,CJDaoChang,CJYear,Masters,CZDaoChang,XZDaoChang,IsOrdained,OrdaineUrl1,OrdaineUrl2,PopularName,DCAddress,DCAttribute,QualificationsUrl,Remarks,Abbot,AbbotIcard,AbbotUrl,AbbotUrl2,AbbotMobile,DCUserName,DCMobile,BuddhistMonksM,BuddhistMonksW,BuddhistMonksCount,BankName,BankICard,Bank,CardNum,OtherInt1,OtherInt2,OtherInt3,OtherInt4,OtherInt5,OtherInt6,OtherInt7,OtherInt8,OtherInt9,OtherInt10,OtherInt11,OtherInt12,OtherInt13,OtherInt14,OtherInt15,OtherString1,OtherString2,OtherString3,OtherString4,OtherString5,OtherString6,OtherString7,OtherString8,OtherString9,OtherString10,OtherString11,OtherString12,OtherString13,OtherString14,OtherString15,OtherText1,OtherText2,OtherText3,OtherText4,OtherText5,MemTypeIDs1,MemTypeIDs2,MemTypeIDs3,MemTypeIDs4,MemTypeIDs5,MemTypeIDs6,MemTypeIDs7,MemTypeIDs8,MemTypeIDs9,MemTypeIDs10,MemTypeIDs11,MemTypeIDs12,MemTypeIDs13,MemTypeIDs14,MemTypeIDs15,MemTypeIDs,MemTypeIDCount,MemTypeIDs7AttrIDS,IntegralQfPt,IsIntegralPayFreeSecret from SW_User ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
        ...
        /// 得到一个对象实体
        /// </summary>
        public WebSite.Model.Mod_User DataRowToModel(DataRow row)
        {
            WebSite.Model.Mod_User model = new WebSite.Model.Mod_User();
            if (row != null)
            {
                ...
                if (row["IntegralQfPt"] != null && row["IntegralQfPt"].ToString() != "")
                {
                    model.IntegralQfPt = int.Parse(row["IntegralQfPt"].ToString());
                }
                if (row["IsIntegralPayFreeSecret"] != null && row["IsIntegralPayFreeSecret"].ToString() != "")
                {
                    model.IsIntegralPayFreeSecret = int.Parse(row["IsIntegralPayFreeSecret"].ToString());
                }
            }
            return model;
        }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,Model,UserName,RealName,NiceName,Password,PayPassword,Problem,Answer,Sex,Company,BirthDate,Image,PicSmall,PicBig,State,IsFreeBroker,IsShop,Integral,TotalIntegral,FreezeIntegral,IntegralSell,IntegralSellFreeze,Money,ConsumptionMoney,FreezeMoney,TypeID,LevelID,LevelClass,LevelName,LevelIntegral,LevelMoney,ModifyDate,OrderBy,Email,EmailCode,EmailAudit,EmailAuditDate,Countries,Province,City,Region,Address,Mobile,Contact,HomeUrl,NewLoginIP,NewLoginDate,LoginIP,LoginDate,LoginCount,RegisterIP,RegisterDate,UnionID,SignCount,SignDate,BrowseCount,CommentCount,FabulousCount,ReportCount,FollowCount,FansCount,UserRemarks,WebSiteID,IsNeedAudit,PointAllmoney,PointAllIntegral,MboxAllmoney,MboxAllIntegral,ActionCount,MemberMessageids,Icard,IcardUrl,IcardUrl2,Qq,WeiXin,CurrentResidence,IsPublic,AuditState,AuthenticationID,AuthenticationName,FaHao,GYShiFu,GYDaoChang,GYYear,Enterprise,EnterpriseNum,EnterpriseUrl,Industry,RegAddress,RegUrl,Header,HeaderMobile,CJDaoChang,CJYear,Masters,CZDaoChang,XZDaoChang,IsOrdained,OrdaineUrl1,OrdaineUrl2,PopularName,DCAddress,DCAttribute,QualificationsUrl,Remarks,Abbot,AbbotIcard,AbbotUrl,AbbotUrl2,AbbotMobile,DCUserName,DCMobile,BuddhistMonksM,BuddhistMonksW,BuddhistMonksCount,BankName,BankICard,Bank,CardNum,OtherInt1,OtherInt2,OtherInt3,OtherInt4,OtherInt5,OtherInt6,OtherInt7,OtherInt8,OtherInt9,OtherInt10,OtherInt11,OtherInt12,OtherInt13,OtherInt14,OtherInt15,OtherString1,OtherString2,OtherString3,OtherString4,OtherString5,OtherString6,OtherString7,OtherString8,OtherString9,OtherString10,OtherString11,OtherString12,OtherString13,OtherString14,OtherString15,OtherText1,OtherText2,OtherText3,OtherText4,OtherText5,MemTypeIDs1,MemTypeIDs2,MemTypeIDs3,MemTypeIDs4,MemTypeIDs5,MemTypeIDs6,MemTypeIDs7,MemTypeIDs8,MemTypeIDs9,MemTypeIDs10,MemTypeIDs11,MemTypeIDs12,MemTypeIDs13,MemTypeIDs14,MemTypeIDs15,MemTypeIDs,MemTypeIDCount,MemTypeIDs7AttrIDS,IntegralQfPt,IsIntegralPayFreeSecret ");
            strSql.Append(" FROM SW_User ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" ID,Model,UserName,RealName,NiceName,Password,PayPassword,Problem,Answer,Sex,Company,BirthDate,Image,PicSmall,PicBig,State,IsFreeBroker,IsShop,Integral,TotalIntegral,FreezeIntegral,IntegralSell,IntegralSellFreeze,Money,ConsumptionMoney,FreezeMoney,TypeID,LevelID,LevelClass,LevelName,LevelIntegral,LevelMoney,ModifyDate,OrderBy,Email,EmailCode,EmailAudit,EmailAuditDate,Countries,Province,City,Region,Address,Mobile,Contact,HomeUrl,NewLoginIP,NewLoginDate,LoginIP,LoginDate,LoginCount,RegisterIP,RegisterDate,UnionID,SignCount,SignDate,BrowseCount,CommentCount,FabulousCount,ReportCount,FollowCount,FansCount,UserRemarks,WebSiteID,IsNeedAudit,PointAllmoney,PointAllIntegral,MboxAllmoney,MboxAllIntegral,ActionCount,MemberMessageids,Icard,IcardUrl,IcardUrl2,Qq,WeiXin,CurrentResidence,IsPublic,AuditState,AuthenticationID,AuthenticationName,FaHao,GYShiFu,GYDaoChang,GYYear,Enterprise,EnterpriseNum,EnterpriseUrl,Industry,RegAddress,RegUrl,Header,HeaderMobile,CJDaoChang,CJYear,Masters,CZDaoChang,XZDaoChang,IsOrdained,OrdaineUrl1,OrdaineUrl2,PopularName,DCAddress,DCAttribute,QualificationsUrl,Remarks,Abbot,AbbotIcard,AbbotUrl,AbbotUrl2,AbbotMobile,DCUserName,DCMobile,BuddhistMonksM,BuddhistMonksW,BuddhistMonksCount,BankName,BankICard,Bank,CardNum,OtherInt1,OtherInt2,OtherInt3,OtherInt4,OtherInt5,OtherInt6,OtherInt7,OtherInt8,OtherInt9,OtherInt10,OtherInt11,OtherInt12,OtherInt13,OtherInt14,OtherInt15,OtherString1,OtherString2,OtherString3,OtherString4,OtherString5,OtherString6,OtherString7,OtherString8,OtherString9,OtherString10,OtherString11,OtherString12,OtherString13,OtherString14,OtherString15,OtherText1,OtherText2,OtherText3,OtherText4,OtherText5,MemTypeIDs1,MemTypeIDs2,MemTypeIDs3,MemTypeIDs4,MemTypeIDs5,MemTypeIDs6,MemTypeIDs7,MemTypeIDs8,MemTypeIDs9,MemTypeIDs10,MemTypeIDs11,MemTypeIDs12,MemTypeIDs13,MemTypeIDs14,MemTypeIDs15,MemTypeIDs,MemTypeIDCount,MemTypeIDs7AttrIDS,IntegralQfPt,IsIntegralPayFreeSecret ");
            strSql.Append(" FROM SW_User ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            if (startIndex <= 1)
            {
                strSql = "select top " + endIndex + " * from SW_User where  " + strWhere + "  order by " + orderby + " ";
            }
            else
            {
                strSql = "select top " + endIndex + " * from SW_User where  " + strWhere + " and  ID not in ( select top " + endIndex * (startIndex - 1) + " ID from SW_User where  " + strWhere + "  order by " + orderby + " ) order by " + orderby + " ";
            }
        ...
        public DataSet GetListByPage2(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            if (startIndex <= 1)
            {
                strSql = "select top " + endIndex + " ID,Model,NiceName,Problem,Answer,Company,BirthDate,Image,PicSmall,PicBig,LevelID,LevelClass,LevelName,RegisterDate,AuthenticationID,OtherString5,Province,City  from SW_User where  " + strWhere + "  order by " + orderby + " ";
            }
            else
            {
                strSql = "select top " + endIndex + " ID,Model,NiceName,Problem,Answer,Company,BirthDate,Image,PicSmall,PicBig,LevelID,LevelClass,LevelName,RegisterDate,AuthenticationID,OtherString5,Province,City  from SW_User where  " + strWhere + " and  ID not in ( select top " + endIndex * (startIndex - 1) + " ID from SW_User where  " + strWhere + "  order by " + orderby + " ) order by " + orderby + " ";
            }
            return DbHelperSQL.Query(strSql);
        }
        /// <summary>
        ...
        public WebSite.Model.Mod_User GetModel(string HomeUrl)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 ID,Model,UserName,RealName,NiceName,Password,PayPassword,Problem,Answer,Sex,Company,BirthDate,Image,PicSmall,PicBig,State,IsFreeBroker,IsShop,Integral,TotalIntegral,FreezeIntegral,IntegralSell,IntegralSellFreeze,Money,ConsumptionMoney,FreezeMoney,TypeID,LevelID,LevelClass,LevelName,LevelIntegral,LevelMoney,ModifyDate,OrderBy,Email,EmailCode,EmailAudit,EmailAuditDate,Countries,Province,City,Region,Address,Mobile,Contact,HomeUrl,NewLoginIP,NewLoginDate,LoginIP,LoginDate,LoginCount,RegisterIP,RegisterDate,UnionID,SignCount,SignDate,BrowseCount,CommentCount,FabulousCount,ReportCount,FollowCount,FansCount,UserRemarks,WebSiteID,IsNeedAudit,PointAllmoney,PointAllIntegral,MboxAllmoney,MboxAllIntegral,ActionCount,MemberMessageids,Icard,IcardUrl,IcardUrl2,Qq,WeiXin,CurrentResidence,IsPublic,AuditState,AuthenticationID,AuthenticationName,FaHao,GYShiFu,GYDaoChang,GYYear,Enterprise,EnterpriseNum,EnterpriseUrl,Industry,RegAddress,RegUrl,Header,HeaderMobile,CJDaoChang,CJYear,Masters,CZDaoChang,XZDaoChang,IsOrdained,OrdaineUrl1,OrdaineUrl2,PopularName,DCAddress,DCAttribute,QualificationsUrl,Remarks,Abbot,AbbotIcard,AbbotUrl,AbbotUrl2,AbbotMobile,DCUserName,DCMobile,BuddhistMonksM,BuddhistMonksW,BuddhistMonksCount,BankName,BankICard,Bank,CardNum,OtherInt1,OtherInt2,OtherInt3,OtherInt4,OtherInt5,OtherInt6,OtherInt7,OtherInt8,OtherInt9,OtherInt10,OtherInt11,OtherInt12,OtherInt13,OtherInt14,OtherInt15,OtherString1,OtherString2,OtherString3,OtherString4,OtherString5,OtherString6,OtherString7,OtherString8,OtherString9,OtherString10,OtherString11,OtherString12,OtherString13,OtherString14,OtherString15,OtherText1,OtherText2,OtherText3,OtherText4,OtherText5,MemTypeIDs1,MemTypeIDs2,MemTypeIDs3,MemTypeIDs4,MemTypeIDs5,MemTypeIDs6,MemTypeIDs7,MemTypeIDs8,MemTypeIDs9,MemTypeIDs10,MemTypeIDs11,MemTypeIDs12,MemTypeIDs13,MemTypeIDs14,MemTypeIDs15,MemTypeIDs,MemTypeIDCount,MemTypeIDs7AttrIDS,IntegralQfPt,IsIntegralPayFreeSecret from SW_User ");
            strSql.Append(" where HomeUrl=@HomeUrl");
            SqlParameter[] parameters = {
                    new SqlParameter("@HomeUrl", SqlDbType.VarChar,200)
            };
            parameters[0].Value = HomeUrl;
        ...
        public bool ExistsNiceName(String NiceName)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from SW_User");
            strSql.Append(" where NiceName=@NiceName ");
            SqlParameter[] parameters = {
                new SqlParameter("@NiceName", SqlDbType.NVarChar,200)};
            parameters[0].Value = NiceName;
            return DbHelperSQL.Exists(strSql.ToString(), parameters);
        }
        /// <summary>
        /// 是否存在该用户名
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 * from SW_User ");
            strSql.Append(" where EmailCode=@EmailCode ");
            SqlParameter[] parameters = {
                new SqlParameter("@EmailCode", SqlDbType.VarChar,200)};
        ...
        public WebSite.Model.Mod_User LoginUser(String UserName, String Password)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 * from SW_User ");
            strSql.Append(" where (UserName=@UserName or Mobile=@UserName) and Password=@Password ");
            SqlParameter[] parameters = {
                new SqlParameter("@UserName", SqlDbType.NVarChar,200),
                new SqlParameter("@Password", SqlDbType.VarChar,200)};
            parameters[0].Value = UserName;
        ...
        /// 是否存在该用户昵称
        /// </summary>
        public bool ExistsNiceName(String NiceName, int ID)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from SW_User");
            strSql.Append(" where NiceName=@NiceName and ID!=@ID");
            SqlParameter[] parameters = {
                new SqlParameter("@NiceName", SqlDbType.NVarChar,200),
                 new SqlParameter("@ID", SqlDbType.Int,4)
                                        };
